            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input value="{{$user->name}}" id="name" type="text" name="name" required class="form-control" placeholder="Enter Name">
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="email" value="{{$user->email}}" id="email" name="email" required class="form-control" placeholder="Enter email">
                      </div>
                    </div>
                   </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="password">Password<span style="font-weight: 450; font-size: 13px;"> (Leave blank if you want to keep previous password)</span></label>
