                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" enctype="multipart/form-data"
                            action="{{ route('maintenance.complete', $maintenance->id) }}"
                            aria-label="{{ __('maintenance.complete') }}">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="odo_meter" name="odo_meter"
                                                placeholder="OdoMeter(km)" value="{{ old('odo_meter') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="next_service" name="next_service"
                                                placeholder="Next Service(km)" value="{{ old('next_service') }}" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select required id="maintenance_type[]" name="maintenance_type[]"
                                                            class="form-control">
                                                            <option
                                                                value="{{ $type->maintenance_type->maintenance_type_id }}">
                                                                {{ $type->maintenance_type->maintenance_type_name }}
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" step="any" required
                                                                ...
                                                                name="m_qty[{!! $loop->index !!}][]" placeholder="Qty">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label>Start time - End time<span aria-hidden="true"
                                                    class="required">*</span></label>
                                            <input type='text' class="form-control datetimes"
