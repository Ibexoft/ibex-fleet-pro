            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" enctype="multipart/form-data" action="{{ route('fine.store') }}">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="date_of_offence" autocomplete="date_of_offence"
                                                required class="date-input form-control"
                                                value="{{ old('date_of_offence') }}" id="date_of_offence"
                                                placeholder="Enter Date of Offence">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select onchange="FetchDriver.call(this, event)" name="vehicle_reg_id"
                                                class="form-control select2 err-tooltip" id="vehicle_reg_id" required>
                                                <option value="">Select Vehicle</option>
                                                @foreach ($vehicle as $vehicleData)
                                                    <option value="{{ $vehicleData->vehicle_id }}"
                                                        @if (old('vehicle_reg_id') == $vehicleData->vehicle_id) selected @endif>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputPhone1">Amount<span aria-hidden="true"
                                                    class="required">*</span></label>
                                            <input type="number" name="amount" autocomplete="amount" required
                                                class="form-control" value="{{ old('amount') }}" id="amount"
                                                placeholder="Enter Amount" min="0" max="99999999" step="0.01">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Notice Number<span aria-hidden="true"
                                                    class="required">*</span></label>
                                            <input required type="text" name="notice" autocomplete="notice"
                                                class="form-control" value="{{ old('notice') }}" id="notice"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required name="notice_type" class="form-control select2 err-tooltip"
                                                ...
                                                @foreach ($notice_types as $key => $notice_type)
                                                    <option value="{{ $key }}"
                                                        @if (old('notice_type') == $key) selected @endif>
                                                        {{ $notice_type }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6" id="council-name-field">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="council_name" autocomplete="council_name"
                                                class="form-control" value="{{ old('council_name') }}" id="council_name"
                                    ...
                                    <div class="col-md-6" id="recovery-company-field">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="recovery_company" autocomplete="recovery_company"
                                                class="form-control" value="{{ old('recovery_company') }}"
                                    ...
                                    <div class="col-md-6" id="police-state-field">
                                        <div class="form-group">
                                            ...
                                            <select name="police_state" class="form-control select2 err-tooltip"
                                                id="police_state">
                                                <option value="" selected disabled>Select Police State</option>
                                                @foreach ($police_states as $police_state)
                                                    <option value="{{ $police_state }}"
                                                        @if (old('police_state') === $police_state) selected @endif>
                                                        {{ $police_state }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputPhone1">Due Date<span aria-hidden="true"
                                                    class="required">*</span></label>
                                            <input type="text" name="due_date" autocomplete="due_date" required
                                                class="date-input form-control" value="{{ old('due_date') }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputPhone1">Date Process<span aria-hidden="true"
                                                    class="required">*</span></label>
                                            <input type="text" name="date_process" autocomplete="date_process"
                                                required class="date-input form-control"
                                                value="{{ old('date_process') }}" id="date_process"
                                                placeholder="Enter Date Process">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6" id="comment-field">
                                        <div class="form-group">
                                            <label for="comment">Comment<span aria-hidden="true"
                                                    class="required">*</span></label>
                                            <input type="text" name="comment" autocomplete="comment"
                                                class="form-control" value="{{ old('comment') }}" id="comment"
...
@section('script')
    ...
    @if (old('vehicle_reg_id'))
        <script>
            $(document).ready(function() {
                var carID = "{{ old('vehicle_reg_id') }}";
                FetchOwner(carID);
            });
        </script>
    @endif
